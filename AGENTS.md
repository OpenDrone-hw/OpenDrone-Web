...
- Run a preorder campaign: batches per SKU in `content/preorders.json`; set a batch's `ships` once its supplier order is placed. Prices, including the compare-at price after a target, are changed in Shopify, never here.
